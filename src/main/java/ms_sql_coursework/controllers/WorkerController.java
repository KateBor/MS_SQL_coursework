...
public class WorkerController implements Controller {
    ...
    public WorkerController(Connection conn, MS_SQL_App app) throws Exception {
        connection = conn;
        msSqlApp = app;
    ...
    public void onClickFunc(ActionEvent actionEvent) {
        ...
        String funcName = workerMap.get(name);
    ...
    public void fillButtons(String email) {
        ...
        for (var i: workerMap.keySet().stream().sorted().toList()) {
