...
import static ms_sql_coursework.model.Constants.adminMap;
import static ms_sql_coursework.model.Constants.withoutParams;
...
public class AdminController implements Controller {
    ...
    public AdminController(Connection conn, MS_SQL_App app) throws Exception {
        connection = conn;
        msSqlApp = app;
    ...
    public void onClickFunc(ActionEvent actionEvent) {
        ...
        String funcName = adminMap.get(name);
